...
object Constants {
    ...
    const val SERIALIZED_CREATED_BY = "created_by"
    const val SERIALIZED_DESCRIPTION = "description"
    const val SERIALIZED_FAVORITE_COUNT = "favorite_count"
    const val SERIALIZED_ITEMS = "items"


    //Movie
    const val SERIALIZED_ADULT = "adult"
    const val SERIALIZED_BACKDROP_PATH = "backdrop_path"
    const val SERIALIZED_GENRES_ID = "genre_ids"
    const val SERIALIZED_ID = "id"
    const val SERIALIZED_MEDIA_TYPE = "media_type"
